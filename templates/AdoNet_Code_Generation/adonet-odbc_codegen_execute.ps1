...
Copy-Item "$src_dir\TextMetal.Common.WebApps\bin\$build_flavor_dir\TextMetal.Common.WebApps.dll" "$base_lib_dir\TextMetal\."
Copy-Item "$src_dir\TextMetal.Common.WebApps\bin\$build_flavor_dir\TextMetal.Common.WebApps.xml" "$base_lib_dir\TextMetal\."
Copy-Item "$src_dir\TextMetal.Common.WebApps\bin\$build_flavor_dir\TextMetal.Common.WebApps.pdb" "$base_lib_dir\TextMetal\."
