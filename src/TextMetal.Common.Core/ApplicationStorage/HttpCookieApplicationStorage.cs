...
{
	public class HttpCookieApplicationStorage : IApplicationStorage
	{
		#region Constructors/Destructors

		public HttpCookieApplicationStorage()
		{
		}
		...
		public T GetValue<T>(string key)
		{
			...
			if (!DataType.Instance.TryParse(httpCookie.Value, out value))
				return default(T);
