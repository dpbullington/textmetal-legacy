	...
	public class TypeHelper
	{
		...
		public static Type BestCommonType(Type type1, Type type2)
		{
			...
			if (IsNumeric(type1) && IsNumeric(type2))
			{
				...
				if (type1 == typeof(UInt64))
					return type1;
				if (type2 == typeof(UInt64))
					return type2;
				...
				if (type1 == typeof(UInt32))
					return type1;
				if (type2 == typeof(UInt32))
					return type2;

				if (type1 == typeof(Int32))
					return type1;
				if (type2 == typeof(Int32))
					return type2;

				if (type1 == typeof(UInt16))
					return type1;
				if (type2 == typeof(UInt16))
					return type2;

				if (type1 == typeof(Int16))
					return type1;
				if (type2 == typeof(Int16))
					return type2;
