...
namespace Castle.DynamicProxy
{
	...
	public interface IChangeProxyTarget
	{
		...
		/// <remarks>
		/// Although the method takes <see cref="object" /> the actual instance must be of type assignable to
		/// <see
		///     cref="IInvocation.TargetType" />
		/// , otherwise an <see cref="InvalidCastException" /> will be thrown.
		...
		/// In this case last interceptor in the pipeline mustn't call <see cref="IInvocation.Proceed" /> or a
		/// <see
		...
		/// <remarks>
		/// Although the method takes <see cref="object" /> the actual instance must be of type assignable to proxy's target type, otherwise an
		/// <see
