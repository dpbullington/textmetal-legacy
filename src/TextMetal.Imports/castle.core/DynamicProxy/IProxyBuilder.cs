...
namespace Castle.DynamicProxy
{
	...
	public interface IProxyBuilder
	{
		...
		/// <summary>
		/// Creates a proxy type for given <paramref name="classToProxy" />, implementing
		/// <paramref
		///     name="additionalInterfacesToProxy" />
		/// , using <paramref name="options" /> provided.
		/// </summary>
		...
		/// Additional interfaces should be only 'mark' interfaces, that is, they should work like interface proxy without target. (See
		/// <see
		///     cref="CreateInterfaceProxyTypeWithoutTarget" />
		/// method.)
		/// </remarks>
		/// <exception cref="GeneratorException">
		/// Thrown when <paramref name="classToProxy" /> or any of
		/// <paramref
		///     name="additionalInterfacesToProxy" />
		...
		/// <paramref
		///     name="targetType" />
		/// , implementing <paramref name="additionalInterfacesToProxy" />, using
		/// <paramref
		///     name="options" />
		/// provided.
		/// </summary>
		...
		/// </remarks>
		/// <exception cref="GeneratorException">
		/// Thrown when <paramref name="interfaceToProxy" /> or any of
		/// <paramref
		///     name="additionalInterfacesToProxy" />
		/// is a generic type definition.
		/// </exception>
		...
		/// <summary>
		/// Creates a proxy type for given <paramref name="interfaceToProxy" /> and
		/// <parmaref
		///     name="additionalInterfacesToProxy" />
		/// that delegates all calls to the provided interceptors and allows interceptors to switch the actual target of invocation.
		/// </summary>
		/// <param name="interfaceToProxy"> The interface type to proxy. </param>
		/// <param name="additionalInterfacesToProxy"> Additional interface types to proxy. </param>
		/// <param name="options"> The proxy generation options. </param>
		...
		/// and uses an instance of the interface as their targets (i.e. <see cref="IInvocation.InvocationTarget" />), rather than a class. All
		/// <see
		///     cref="IInvocation" />
		/// classes should then implement <see cref="IChangeProxyTarget" /> interface,
