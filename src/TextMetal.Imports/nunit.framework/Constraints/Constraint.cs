...
namespace NUnit.Framework.Constraints
{
	...
	public abstract class Constraint : IResolveConstraint
	{
		...
		public string DisplayName
		{
			get
			{
				...
				{
					this.displayName = this.GetType().Name.ToLower();
	...
	/// <returns>True for success, false for failure</returns>
		...
		public override string ToString()
		{
			string rep = this.GetStringRepresentation();
		...
		protected virtual string GetStringRepresentation()
		{
			switch (this.argcnt)
			{
				...
				case 1:
					return string.Format("<{0} {1}>", this.DisplayName, this._displayable(this.arg1));
				case 2:
					return string.Format("<{0} {1} {2}>", this.DisplayName, this._displayable(this.arg1), this._displayable(this.arg2));
			}
		}
		...
		public DelayedConstraint After(int delayInMilliseconds)
		{
			return new DelayedConstraint(
				this.builder == null ? this : this.builder.Resolve(),
				delayInMilliseconds);
		}
