...
namespace NUnit.Framework.Constraints
{
	...
	public class DelayedConstraint : PrefixConstraint
	{
		...
		{
			int remainingDelay = this.delayInMilliseconds;

			while (this.pollingInterval > 0 && this.pollingInterval < remainingDelay)
			{
				remainingDelay -= this.pollingInterval;
