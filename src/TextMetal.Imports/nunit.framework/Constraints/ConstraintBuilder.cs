...
namespace NUnit.Framework.Constraints
{
	...
	public class ConstraintBuilder
	{
		...
		private void SetTopOperatorRightContext(object rightContext)
		{
			...
			int oldPrecedence = this.ops.Top.LeftPrecedence;
			...
			if (this.ops.Top.LeftPrecedence > oldPrecedence)
			{
				ConstraintOperator changedOp = this.ops.Pop();
				this.ReduceOperatorStack(changedOp.LeftPrecedence);
				this.ops.Push(changedOp);
			}
		}
