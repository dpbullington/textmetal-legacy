...
namespace NUnit.Framework.Constraints
{
	...
	public class EqualConstraint : Constraint
	{
		...
		{
			int mismatch = MsgUtils.FindMismatchPosition(expected, actual, 0, this.comparer.IgnoreCase);
			...
			writer.DisplayStringDifferences(expected, actual, mismatch, this.comparer.IgnoreCase, this.clipStrings);
		}
		...
		private void DisplayStreamDifferences(MessageWriter writer, Stream expected, Stream actual, int depth)
		{
			if (expected.Length == actual.Length)
			{
				long offset = (long)this.comparer.FailurePoints[depth];
		...
		private void DisplayCollectionDifferences(MessageWriter writer, ICollection expected, ICollection actual, int depth)
		{
			...
			{
				NUnitEqualityComparer.FailurePoint failurePoint = (NUnitEqualityComparer.FailurePoint)this.comparer.FailurePoints[depth];
