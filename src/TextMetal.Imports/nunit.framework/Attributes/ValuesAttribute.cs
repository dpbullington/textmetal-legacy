...
namespace NUnit.Framework
{
	...
	public class ValuesAttribute : ParameterDataAttribute
	{
		...
		{
			this.data = new object[] { arg1, arg2 };
		}
		...
		{
			this.data = new object[] { arg1, arg2, arg3 };
		}
		...
		public override IEnumerable GetData(ParameterInfo parameter)
		{
			...
			for (int i = 0; i < this.data.Length; i++)
			{
				...
				if (convert)
					this.data[i] = Convert.ChangeType(arg, targetType, CultureInfo.InvariantCulture);
			}
