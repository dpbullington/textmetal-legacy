...
namespace NUnit.Core
{
	...
	public class OSPlatform
	{
		...
		public bool IsWin32S
		{
			get
			{
				return this.platform == PlatformID.Win32S;
			}
		}
		...
		public bool IsWin32Windows
		{
			get
			{
				return this.platform == PlatformID.Win32Windows;
			}
		}
		...
		public bool IsWinCE
		{
			get
			{
				return (int)this.platform == 3;
			} // PlatformID.WinCE not defined in .NET 1.0
		}
		...
		public bool IsXbox
		{
			get
			{
				return this.platform == PlatformID.Xbox;
			}
		}
		...
		public bool IsWin95
		{
			get
			{
				return this.platform == PlatformID.Win32Windows && this.version.Major == 4 && this.version.Minor == 0;
			}
		}
		...
		public bool IsWin98
		{
			get
			{
				return this.platform == PlatformID.Win32Windows && this.version.Major == 4 && this.version.Minor == 10;
			}
		}
		...
		public bool IsWinME
		{
			get
			{
				return this.platform == PlatformID.Win32Windows && this.version.Major == 4 && this.version.Minor == 90;
			}
		}
		...
		public bool IsNT3
		{
			get
			{
				return this.platform == PlatformID.Win32NT && this.version.Major == 3;
			}
		}
		...
		public bool IsNT4
		{
			get
			{
				return this.platform == PlatformID.Win32NT && this.version.Major == 4;
			}
		}
		...
		public bool IsNT5
		{
			get
			{
				return this.platform == PlatformID.Win32NT && this.version.Major == 5;
			}
		}
		...
		public bool IsWin2K
		{
			get
			{
				return this.IsNT5 && this.version.Minor == 0;
			}
		}
		...
		public bool IsWinXP
		{
			get
			{
				return this.IsNT5 && this.version.Minor == 1 || (this.version.Minor == 2 && this.Product == ProductType.WorkStation);
			}
		}
		...
		public bool IsWin2003Server
		{
			get
			{
				return this.IsNT5 && this.version.Minor == 2 && this.Product == ProductType.Server;
			}
		}
		...
		public bool IsVista
		{
			get
			{
				return this.IsNT6 && this.version.Minor == 0 && this.Product == ProductType.WorkStation;
			}
		}
		...
		public bool IsWin2008Server
		{
			get
			{
				return this.IsNT6 && this.Product == ProductType.Server;
			}
		}
		...
		public bool IsWin2008ServerR1
		{
			get
			{
				return this.IsNT6 && this.version.Minor == 0 && this.Product == ProductType.Server;
			}
		}
		...
		public bool IsWin2008ServerR2
		{
			get
			{
				return this.IsNT6 && this.version.Minor == 1 && this.Product == ProductType.Server;
			}
		}
		...
		public bool IsWin2012Server
		{
			get
			{
				return this.IsNT6 && this.version.Minor == 2 && this.Product == ProductType.Server;
			}
		}
		...
		public bool IsWindows7
		{
			get
			{
				return this.IsNT6 && this.version.Minor == 1 && this.Product == ProductType.WorkStation;
			}
		}
		...
		public bool IsWindows8
		{
			get
			{
				return this.IsNT6 && this.version.Minor == 2 && this.Product == ProductType.WorkStation;
			}
		}
	}
}