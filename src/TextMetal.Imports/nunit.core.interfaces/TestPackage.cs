...
namespace NUnit.Core
{
	...
	public class TestPackage
	{
		...
		public bool AutoBinPath
		{
			get
			{
				return this.autoBinPath;
			}
			set
			{
				this.autoBinPath = value;
			}
		}
		...
		{
			object setting = this.settings[name];
		...
		public Enum GetSetting(string name, Enum defaultSetting)
		{
			...
			return setting == null ? defaultSetting : (Enum)setting;
		}
