...
namespace NUnit.Core
{
	...
	public sealed class RuntimeFramework
	{
		...
		public bool AllowAnyVersion
		{
			get
			{
				return this.clrVersion == DefaultVersion;
			}
		}
		...
		public override string ToString()
		{
			...
			{
				string vstring = this.frameworkVersion.ToString();
				if (this.runtime == RuntimeType.Any)
					return "v" + vstring;
				else
					return this.runtime.ToString().ToLower() + "-" + vstring;
			}
		}
