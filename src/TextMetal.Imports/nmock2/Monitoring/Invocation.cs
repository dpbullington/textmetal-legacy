...
namespace NMock2.Monitoring
{
	...
	public class Invocation : ISelfDescribing
	{
		...
		/// </summary>
		/// <value> <c>true</c> if this invocation is throwing an exception; otherwise, <c>false</c> . </value>
		...
		/// <returns> Returns a string containing the description of the given object's interfaces. </returns>
		...
		/// </summary>
		/// <returns> Returns true if initialized method is an event adder; false otherwise. </returns>
		...
		/// </summary>
		/// <returns> Returns true if initialized method is an event remover; false otherwise. </returns>
		...
		/// </summary>
		/// <returns> Returns true if initialized method is an index getter; false otherwise. </returns>
		...
		/// </summary>
		/// <returns> Returns true if initialized method is an index setter; false otherwise. </returns>
		...
		/// </summary>
		/// <returns> Returns true if initialized method is a property; false otherwise. </returns>
