...
namespace NUnit.Gui.SettingsPages
{
	public class TestLoaderSettingsPage : SettingsPage
	{
		...
		{
			this.mergeAssembliesCheckBox = new CheckBox();
			this.singleDomainRadioButton = new RadioButton();
			this.multiDomainRadioButton = new RadioButton();
			this.helpProvider1 = new HelpProvider();
			this.label3 = new Label();
			this.groupBox3 = new GroupBox();
			this.multiProcessRadioButton = new RadioButton();
			this.separateProcessRadioButton = new RadioButton();
			this.sameProcessRadioButton = new RadioButton();
			...
			this.mergeAssembliesCheckBox.Location = new Point(48, 221);
			...
			this.mergeAssembliesCheckBox.Size = new Size(169, 17);
			...
			this.singleDomainRadioButton.Location = new Point(32, 190);
			...
			this.singleDomainRadioButton.Size = new Size(194, 17);
			...
			this.singleDomainRadioButton.Click += new EventHandler(this.toggleMultiDomain);
			// 
			...
			this.groupBox3.Anchor = ((AnchorStyles)(((AnchorStyles.Top | AnchorStyles.Left)
													| AnchorStyles.Right)));
			this.groupBox3.Location = new Point(199, 8);
			this.groupBox3.Name = "groupBox3";
			this.groupBox3.Size = new Size(253, 8);
			...
			this.sameProcessRadioButton.CheckedChanged += new EventHandler(this.toggleProcessUsage);
			// 
			// label2
			// 
			...
			this.groupBox2.Anchor = ((AnchorStyles)(((AnchorStyles.Top | AnchorStyles.Left)
													| AnchorStyles.Right)));
			this.groupBox2.Location = new Point(199, 136);
			this.groupBox2.Name = "groupBox2";
			this.groupBox2.Size = new Size(253, 8);
