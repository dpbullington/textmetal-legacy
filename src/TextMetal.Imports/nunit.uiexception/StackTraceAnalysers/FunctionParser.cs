...
namespace NUnit.UiException.StackTraceAnalysers
{
		...
		IErrorParser
	{
		...
		/// </summary>
		/// <param name="parser"> An instance of parser, this parameter cannot be null. </param>
		/// <param name="args"> An instance of RawError. This parameter cannot be null. </param>
