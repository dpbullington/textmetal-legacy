...
namespace NUnit.UiException.CodeFormatters
{
		...
		IEnumerable
	{
		...
		{
			this._toFormatter = new Dictionary<string, ICodeFormatter>();
		...
		public ICodeFormatter this[string language]
		{
			get
			{
				...
				foreach (ICodeFormatter item in this._toFormatter.Values)
				{
		...
		public int Count
		{
			get
			{
				return (this._toFormatter.Count);
			}
		}
		...
		public StringCollection Extensions
		{
			get
			{
				...
				foreach (string extension in this._toFormatter.Keys)
					res.Add(extension);
		...
		{
			return (this._toFormatter.Values.GetEnumerator());
		}
		...
		public ICodeFormatter GetFromExtension(string extension)
		{
			...
			return (this._toFormatter[extension]);
		}
		...
		public bool HasExtension(string extension)
		{
			...
			return (this._toFormatter.ContainsKey(extension));
		}
		...
		public void Remove(string extension)
		{
			...
			this._toFormatter.Remove(extension);
