...
namespace NUnit.UiKit
{
	...
	public class EditTabPagesDialog : NUnitFormBase
	{
		...
		private void InitializeComponent()
		{
			...
			this.tabPageListBox = new ListBox();
			...
			// addButton
			// 
			this.addButton.Location = new Point(192, 48);
			...
			this.closeButton.Location = new Point(190, 218);
			...
			// removeButton
			// 
			this.removeButton.Location = new Point(190, 10);
			...
			this.tabPageListBox.Location = new Point(6, 10);
			this.tabPageListBox.Name = "tabPageListBox";
			this.tabPageListBox.Size = new Size(168, 212);
			this.tabPageListBox.TabIndex = 6;
			this.tabPageListBox.SelectedIndexChanged += new EventHandler(this.tabPageListBox_SelectedIndexChanged);
			// 
			// moveUpButton
			// 
			this.moveUpButton.Location = new Point(192, 88);
			this.moveUpButton.Name = "moveUpButton";
			this.moveUpButton.Size = new Size(96, 32);
			...
			// moveDownButton
			// 
			this.moveDownButton.Location = new Point(192, 128);
			this.moveDownButton.Name = "moveDownButton";
			this.moveDownButton.Size = new Size(96, 32);
			...
			this.ClientSize = new Size(292, 260);
			...
			this.Load += new EventHandler(this.EditTabPagesDialog_Load);
