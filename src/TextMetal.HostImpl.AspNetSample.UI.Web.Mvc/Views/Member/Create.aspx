<%@ Page Title="Create a New Member" MasterPageFile="~/Views/Shared/SiteBase.Master" Language="C#" Inherits="System.Web.Mvc.ViewPage<TextMetal.HostImpl.AspNetSample.UI.Web.Mvc.Models.MemberViewModel>" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MiddleContent" runat="server">
	...
	<p>Creating a new member in this organization requires the following information.</p>
	   ...
	   { %>
		...
		<div class="txtmtl-data-form">
			...
			<div class="txtmtl-data-button">
				<input type="submit" class="txtmtl-input-button" value="Create" id="Create" />
			</div>
		</div>
	<% } %>
