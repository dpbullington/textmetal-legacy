<%@ Page Title="Create a Circle" MasterPageFile="~/Views/Shared/SiteBase.Master" Language="C#" Inherits="System.Web.Mvc.ViewPage<TextMetal.HostImpl.AspNetSample.DomainModel.Tables.Circle>" %>
