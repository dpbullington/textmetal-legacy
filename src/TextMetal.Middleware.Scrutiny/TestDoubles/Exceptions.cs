...
namespace NMock
{
	...
	public class ExpectationException : Exception
	{
		...
		protected ExpectationException(string message, Exception innerException)
	...
	public class IncompleteExpectationException : ExpectationException
	{
		...
		/// </summary>
		/// <param name="message"> </param>
		public IncompleteExpectationException(string message)
			: base(message)
		{
		}
