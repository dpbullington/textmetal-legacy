...
namespace Castle.DynamicProxy.Generators
{
	...
	public class ClassProxyWithTargetGenerator : BaseProxyGenerator
	{
		...
		{
#if NETCORE
			var cacheKey = new CacheKey(this.targetType.GetTypeInfo(), this.targetType, this.additionalInterfacesToProxy, this.ProxyGenerationOptions);
#else
			...
			INamingScope namingScope)
		{
			...
			var proxyInstance = new ClassProxyWithTargetInstanceContributor(this.targetType, methodsToSkip, this.additionalInterfacesToProxy,
