...
namespace Castle.DynamicProxy
{
	...
	public class ProxyGenerator
	{
		...
		/// <summary>
		/// Creates proxy object intercepting calls to members of interface <typeparamref name="TInterface" /> on
		/// <paramref
		///     name="target" />
		...
		/// Thrown when no default constructor exists on actual type of
		/// <paramref
		///     name="target" />
		/// object.
		/// </exception>
		/// <exception cref="TargetInvocationException">
		/// Thrown when default constructor of actual type of
		/// <paramref
		///     name="target" />
		/// throws an exception.
		/// </exception>
			...
			where TInterface : class
		{
			...
			return
				(TInterface)this.CreateInterfaceProxyWithTarget(typeof(TInterface), target, ProxyGenerationOptions.Default, interceptors);
		}
		...
		/// use
		/// <see
		///     cref="CreateInterfaceProxyWithTargetInterface{TInterface}(TInterface,Castle.DynamicProxy.ProxyGenerationOptions,IInterceptor[])" />
		/// method.
		/// This method uses <see cref="IProxyBuilder" /> implementation to generate a proxy type.
		/// As such caller should expect any type of exception that given <see cref="IProxyBuilder" /> implementation may throw.
		/// </remarks>
		public TInterface CreateInterfaceProxyWithTarget<TInterface>(TInterface target, ProxyGenerationOptions options,
			...
			where TInterface : class
		{
			return (TInterface)this.CreateInterfaceProxyWithTarget(typeof(TInterface), target, options, interceptors);
		}

		/// <summary>
		/// Creates proxy object intercepting calls to members of interface <paramref name="interfaceToProxy" /> on
		/// <paramref
		///     name="target" />
		/// object with given <paramref name="interceptors" />.
		/// </summary>
		...
		/// Thrown when given <paramref name="target" /> does not implement
		/// <paramref
		...
		public object CreateInterfaceProxyWithTarget(Type interfaceToProxy, object target, ProxyGenerationOptions options,
			params IInterceptor[] interceptors)
		{
			return this.CreateInterfaceProxyWithTarget(interfaceToProxy, null, target, options, interceptors);
		}
		...
		/// <param name="interceptors"> The interceptors called during the invocation of proxied methods. </param>
		/// <returns>
		/// Object proxying calls to members of <paramref name="interfaceToProxy" /> and
		/// <paramref
		///     name="additionalInterfacesToProxy" />
		/// types  on <paramref name="target" /> object.
		/// </returns>
		/// <exception cref="ArgumentNullException"> Thrown when given <paramref name="interfaceToProxy" /> object is a null reference (Nothing in Visual Basic). </exception>
		/// <exception cref="ArgumentNullException"> Thrown when given <paramref name="target" /> object is a null reference (Nothing in Visual Basic). </exception>
		/// <exception cref="ArgumentNullException"> Thrown when given <paramref name="interceptors" /> array is a null reference (Nothing in Visual Basic). </exception>
		/// <exception cref="ArgumentException">
		/// Thrown when given <paramref name="interfaceToProxy" /> or any of
		/// <paramref
		///     name="additionalInterfacesToProxy" />
		...
		public object CreateInterfaceProxyWithTarget(Type interfaceToProxy, Type[] additionalInterfacesToProxy, object target,
			params IInterceptor[] interceptors)
		{
			return this.CreateInterfaceProxyWithTarget(interfaceToProxy, additionalInterfacesToProxy, target,
			...
			params IInterceptor[] interceptors)
		{
			...
			var generatedType = this.CreateInterfaceProxyTypeWithTarget(interfaceToProxy, additionalInterfacesToProxy, targetType,
				options);

			var arguments = this.GetConstructorArguments(target, interceptors, options);
		...
		///     name="target" />
		/// object with given <paramref name="interceptors" />.
		/// Interceptors can use <see cref="IChangeProxyTarget" /> interface to provide other target for method invocation than default
		/// <paramref
		///     name="target" />
		/// .
		/// </summary>
		...
		public TInterface CreateInterfaceProxyWithTargetInterface<TInterface>(TInterface target,
			...
			where TInterface : class
		{
			return (TInterface)this.CreateInterfaceProxyWithTargetInterface(typeof(TInterface),
				target,
		...
		/// <paramref
		///     name="additionalInterfacesToProxy" />
		/// types on <paramref name="target" /> object or alternative implementation swapped at runtime by an interceptor.
		/// </returns>
		/// <exception cref="ArgumentNullException"> Thrown when given <paramref name="interfaceToProxy" /> object is a null reference (Nothing in Visual Basic). </exception>
		/// <exception cref="ArgumentNullException"> Thrown when given <paramref name="target" /> object is a null reference (Nothing in Visual Basic). </exception>
		/// <exception cref="ArgumentNullException"> Thrown when given <paramref name="interceptors" /> array is a null reference (Nothing in Visual Basic). </exception>
		...
		{
			return this.CreateInterfaceProxyWithTargetInterface(interfaceToProxy, additionalInterfacesToProxy, target,
				ProxyGenerationOptions.Default, interceptors);
		}
		...
		public object CreateInterfaceProxyWithTargetInterface(Type interfaceToProxy, object target,
			...
			params IInterceptor[] interceptors)
		{
			return this.CreateInterfaceProxyWithTargetInterface(interfaceToProxy, null, target, options, interceptors);
		}
			...
			params IInterceptor[] interceptors)
		{
			...
			var generatedType = this.CreateInterfaceProxyTypeWithTargetInterface(interfaceToProxy, additionalInterfacesToProxy,
				options);
			var arguments = this.GetConstructorArguments(target, interceptors, options);
			if (isRemotingProxy)
			{
		...
		/// <summary>
		/// Creates proxy object intercepting calls to members of interface <typeparamref name="TInterface" /> on target object generated at runtime with given
		/// <paramref
		///     name="interceptor" />
		/// .
		/// </summary>
		...
		/// <exception cref="ArgumentException"> Thrown when given <typeparamref name="TInterface" /> is not an interface type. </exception>
		/// <remarks>
		/// Since this method uses an empty-shell implementation of interfaces to proxy generated at runtime, the actual implementation of proxied methods must be provided by given
		/// <see
		///     cref="IInterceptor" />
		/// implementations.
		/// They are responsible for setting return value (and out parameters) on proxied methods. It is also illegal for an interceptor to call
		/// <see
		///     cref="IInvocation.Proceed" />
		/// , since there's no actual implementation to proceed with.
		...
		/// <summary>
		/// Creates proxy object intercepting calls to members of interface <paramref name="interfaceToProxy" /> on target object generated at runtime with given
		/// <paramref
		///     name="interceptor" />
		/// .
		/// </summary>
		...
		{
			return this.CreateInterfaceProxyWithoutTarget(interfaceToProxy, Type.EmptyTypes, ProxyGenerationOptions.Default,
				interceptor);
		}
		...
		/// <paramref
		///     name="additionalInterfacesToProxy" />
		/// types on generated target object.
		/// </returns>
		/// <exception cref="ArgumentNullException"> Thrown when given <paramref name="interfaceToProxy" /> object is a null reference (Nothing in Visual Basic). </exception>
		/// <exception cref="ArgumentNullException"> Thrown when given <paramref name="interceptors" /> array is a null reference (Nothing in Visual Basic). </exception>
		/// <exception cref="ArgumentException">
		...
		public object CreateInterfaceProxyWithoutTarget(Type interfaceToProxy, Type[] additionalInterfacesToProxy,
			params IInterceptor[] interceptors)
		{
			return this.CreateInterfaceProxyWithoutTarget(interfaceToProxy, additionalInterfacesToProxy,
				ProxyGenerationOptions.Default, interceptors);
		}
		...
		/// <exception cref="ArgumentException"> Thrown when given <paramref name="interfaceToProxy" /> is not an interface type. </exception>
		/// <remarks>
		/// Since this method uses an empty-shell implementation of <paramref name="additionalInterfacesToProxy" /> to proxy generated at runtime, the actual implementation of proxied methods must be provided by given
		/// <see
		///     cref="IInterceptor" />
		/// implementations.
		/// They are responsible for setting return value (and out parameters) on proxied methods. It is also illegal for an interceptor to call
			...
			params IInterceptor[] interceptors)
		{
			...
			var generatedType = this.CreateInterfaceProxyTypeWithoutTarget(interfaceToProxy, additionalInterfacesToProxy, options);
			var arguments = this.GetConstructorArguments(null, interceptors, options);
			return Activator.CreateInstance(generatedType, arguments.ToArray());
		}

		/// <summary>
		/// Creates proxy object intercepting calls to virtual members of type <typeparamref name="TClass" /> on newly created instance of that type with given
		/// <paramref
		///     name="interceptors" />
		/// .
		/// </summary>
		...
		public TClass CreateClassProxyWithTarget<TClass>(TClass target, params IInterceptor[] interceptors)
			where TClass : class
		{
			return (TClass)this.CreateClassProxyWithTarget(typeof(TClass),
				Type.EmptyTypes,
				target,
				ProxyGenerationOptions.Default,
				new object[0],
		...
		/// <summary>
		/// Creates proxy object intercepting calls to virtual members of type <paramref name="classToProxy" /> on newly created instance of that type with given
		/// <paramref
		///     name="interceptors" />
		/// .
		/// </summary>
		...
		/// <paramref
		///     name="classToProxy" />
		/// and <paramref name="additionalInterfacesToProxy" /> types.
		/// </returns>
		...
		/// <exception cref="ArgumentException">
		/// Thrown when given <paramref name="classToProxy" /> or any of
		/// <paramref
		///     name="additionalInterfacesToProxy" />
		/// is a generic type definition.
		/// </exception>
		...
		public object CreateClassProxyWithTarget(Type classToProxy, Type[] additionalInterfacesToProxy, object target,
			params IInterceptor[] interceptors)
		{
			return this.CreateClassProxyWithTarget(classToProxy,
		...
		/// <exception cref="ArgumentException"> Thrown when given <paramref name="classToProxy" /> is not a class type. </exception>
		/// <exception cref="ArgumentException">
		/// Thrown when no constructor exists on type <paramref name="classToProxy" /> with parameters matching
		/// <paramref
			...
			params IInterceptor[] interceptors)
		{
			...
			// create constructor arguments (initialized with mixin implementations, interceptors and target type constructor arguments)
			var arguments = this.BuildArgumentListForClassProxyWithTarget(target, options, interceptors);
			if (constructorArguments != null && constructorArguments.Length != 0)
				arguments.AddRange(constructorArguments);
			return this.CreateClassProxyInstance(proxyType, arguments, classToProxy, constructorArguments);
		}
		...
		public object CreateClassProxy(Type classToProxy, ProxyGenerationOptions options, object[] constructorArguments,
			params IInterceptor[] interceptors)
		{
			return this.CreateClassProxy(classToProxy, null, options, constructorArguments, interceptors);
		}
		...
		{
			return this.CreateClassProxy(classToProxy, null, ProxyGenerationOptions.Default, constructorArguments, interceptors);
		}
		...
		{
			return this.CreateClassProxy(classToProxy, null, ProxyGenerationOptions.Default,
				null, interceptors);
		}
		...
		{
			return this.CreateClassProxy(classToProxy, null, options, interceptors);
		}
		...
		public object CreateClassProxy(Type classToProxy, Type[] additionalInterfacesToProxy, ProxyGenerationOptions options,
			params IInterceptor[] interceptors)
		{
			return this.CreateClassProxy(classToProxy, additionalInterfacesToProxy, options, null, interceptors);
		}
			...
			object[] constructorArguments, params IInterceptor[] interceptors)
		{
			...
			var proxyType = this.CreateClassProxyType(classToProxy, additionalInterfacesToProxy, options);

			// create constructor arguments (initialized with mixin implementations, interceptors and target type constructor arguments)
			var arguments = this.BuildArgumentListForClassProxy(options, interceptors);
			if (constructorArguments != null && constructorArguments.Length != 0)
				arguments.AddRange(constructorArguments);
			return this.CreateClassProxyInstance(proxyType, arguments, classToProxy, constructorArguments);
		}
		...
		protected void CheckNotGenericTypeDefinitions(IEnumerable<Type> types, string argumentName)
		{
			...
			foreach (var t in types)
				this.CheckNotGenericTypeDefinition(t, argumentName);
		}
		...
		/// <summary>
		/// Creates the proxy type for class proxy with given <paramref name="classToProxy" /> class, implementing given
		/// <paramref
		///     name="additionalInterfacesToProxy" />
		/// and using provided <paramref name="options" />.
		/// </summary>
		...
		/// <summary>
		/// Creates the proxy type for interface proxy with target for given <paramref name="interfaceToProxy" /> interface, implementing given
		/// <paramref
		///     name="additionalInterfacesToProxy" />
		/// on given <paramref name="targetType" /> and using provided
		/// <paramref
		///     name="options" />
		/// .
		/// </summary>
		...
		{
			// create proxy
			return this.ProxyBuilder.CreateInterfaceProxyTypeWithTarget(interfaceToProxy, additionalInterfacesToProxy, targetType,
				options);
		}

		/// <summary>
		/// Creates the proxy type for interface proxy with target interface for given <paramref name="interfaceToProxy" /> interface, implementing given
		/// <paramref
		///     name="additionalInterfacesToProxy" />
		/// on given <paramref name="interfaceToProxy" /> and using provided
		/// <paramref
		///     name="options" />
		/// .
		/// </summary>
		...
		{
			// create proxy
			return this.ProxyBuilder.CreateInterfaceProxyTypeWithTargetInterface(interfaceToProxy, additionalInterfacesToProxy,
				options);
		}

		/// <summary>
		/// Creates the proxy type for interface proxy without target for given <paramref name="interfaceToProxy" /> interface, implementing given
		/// <paramref
		///     name="additionalInterfacesToProxy" />
		/// and using provided <paramref name="options" />.
		/// </summary>
