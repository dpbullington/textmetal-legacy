...
namespace TextMetal.Common.Data.Framework.PoPimp
{
	...
	public static class ModelMapHelper
	{
		...
		public static TResultModel CreateResultModel<TResultModel>()
			where TResultModel : class, IResultModelObject
		{
