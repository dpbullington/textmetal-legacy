...
namespace TextMetal.HostImpl.AspNetSample.DomainModel
{
	...
	public partial class Repository : LinqToSqlModelRepository<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.TextMetalOdsDataContext>, IRepository
	{
		...
		public override IEnumerable<TModel> Find<TModel>(IUnitOfWork unitOfWork, IModelQuery modelQuery)
		{
			...
			{
				Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Application_Organization, bool>> _predicate = modelQuery.GetNativeReduction() as Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Application_Organization, bool>>;

				if ((object)_predicate == null)
					throw new InvalidOperationException(string.Format("Model query object of type '{0}' returned an invalid native reduction (inner query); expected type is '{1}'.", modelQuery.GetType().FullName, typeof(Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Application_Organization, bool>>).FullName));
			...
			{
				Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Application_Member, bool>> _predicate = modelQuery.GetNativeReduction() as Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Application_Member, bool>>;

				if ((object)_predicate == null)
					throw new InvalidOperationException(string.Format("Model query object of type '{0}' returned an invalid native reduction (inner query); expected type is '{1}'.", modelQuery.GetType().FullName, typeof(Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Application_Member, bool>>).FullName));
			...
			{
				Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.EventLogExtent, bool>> _predicate = modelQuery.GetNativeReduction() as Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.EventLogExtent, bool>>;

				if ((object)_predicate == null)
					throw new InvalidOperationException(string.Format("Model query object of type '{0}' returned an invalid native reduction (inner query); expected type is '{1}'.", modelQuery.GetType().FullName, typeof(Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.EventLogExtent, bool>>).FullName));
			...
			{
				Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Global_User, bool>> _predicate = modelQuery.GetNativeReduction() as Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Global_User, bool>>;

				if ((object)_predicate == null)
					throw new InvalidOperationException(string.Format("Model query object of type '{0}' returned an invalid native reduction (inner query); expected type is '{1}'.", modelQuery.GetType().FullName, typeof(Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Global_User, bool>>).FullName));
			...
			{
				Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Global_SecurityRole, bool>> _predicate = modelQuery.GetNativeReduction() as Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Global_SecurityRole, bool>>;

				if ((object)_predicate == null)
					throw new InvalidOperationException(string.Format("Model query object of type '{0}' returned an invalid native reduction (inner query); expected type is '{1}'.", modelQuery.GetType().FullName, typeof(Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Global_SecurityRole, bool>>).FullName));
			...
			{
				Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Global_PropertyBag, bool>> _predicate = modelQuery.GetNativeReduction() as Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Global_PropertyBag, bool>>;

				if ((object)_predicate == null)
					throw new InvalidOperationException(string.Format("Model query object of type '{0}' returned an invalid native reduction (inner query); expected type is '{1}'.", modelQuery.GetType().FullName, typeof(Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Global_PropertyBag, bool>>).FullName));
			...
			{
				Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Global_EventLog, bool>> _predicate = modelQuery.GetNativeReduction() as Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Global_EventLog, bool>>;

				if ((object)_predicate == null)
					throw new InvalidOperationException(string.Format("Model query object of type '{0}' returned an invalid native reduction (inner query); expected type is '{1}'.", modelQuery.GetType().FullName, typeof(Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Global_EventLog, bool>>).FullName));
			...
			{
				Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Global_EmailMessage, bool>> _predicate = modelQuery.GetNativeReduction() as Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Global_EmailMessage, bool>>;

				if ((object)_predicate == null)
					throw new InvalidOperationException(string.Format("Model query object of type '{0}' returned an invalid native reduction (inner query); expected type is '{1}'.", modelQuery.GetType().FullName, typeof(Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Global_EmailMessage, bool>>).FullName));
			...
			{
				Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Global_EmailAttachment, bool>> _predicate = modelQuery.GetNativeReduction() as Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Global_EmailAttachment, bool>>;

				if ((object)_predicate == null)
					throw new InvalidOperationException(string.Format("Model query object of type '{0}' returned an invalid native reduction (inner query); expected type is '{1}'.", modelQuery.GetType().FullName, typeof(Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Global_EmailAttachment, bool>>).FullName));
			...
			{
				Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.History_OrganizationHistory, bool>> _predicate = modelQuery.GetNativeReduction() as Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.History_OrganizationHistory, bool>>;

				if ((object)_predicate == null)
					throw new InvalidOperationException(string.Format("Model query object of type '{0}' returned an invalid native reduction (inner query); expected type is '{1}'.", modelQuery.GetType().FullName, typeof(Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.History_OrganizationHistory, bool>>).FullName));
			...
			{
				Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.History_MemberHistory, bool>> _predicate = modelQuery.GetNativeReduction() as Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.History_MemberHistory, bool>>;

				if ((object)_predicate == null)
					throw new InvalidOperationException(string.Format("Model query object of type '{0}' returned an invalid native reduction (inner query); expected type is '{1}'.", modelQuery.GetType().FullName, typeof(Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.History_MemberHistory, bool>>).FullName));
			...
			{
				Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.History_UserHistory, bool>> _predicate = modelQuery.GetNativeReduction() as Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.History_UserHistory, bool>>;

				if ((object)_predicate == null)
					throw new InvalidOperationException(string.Format("Model query object of type '{0}' returned an invalid native reduction (inner query); expected type is '{1}'.", modelQuery.GetType().FullName, typeof(Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.History_UserHistory, bool>>).FullName));
			...
			{
				Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.History_SecurityRoleHistory, bool>> _predicate = modelQuery.GetNativeReduction() as Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.History_SecurityRoleHistory, bool>>;

				if ((object)_predicate == null)
					throw new InvalidOperationException(string.Format("Model query object of type '{0}' returned an invalid native reduction (inner query); expected type is '{1}'.", modelQuery.GetType().FullName, typeof(Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.History_SecurityRoleHistory, bool>>).FullName));
			...
			{
				Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.History_PropertyBagHistory, bool>> _predicate = modelQuery.GetNativeReduction() as Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.History_PropertyBagHistory, bool>>;

				if ((object)_predicate == null)
					throw new InvalidOperationException(string.Format("Model query object of type '{0}' returned an invalid native reduction (inner query); expected type is '{1}'.", modelQuery.GetType().FullName, typeof(Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.History_PropertyBagHistory, bool>>).FullName));
			...
			{
				Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.History_EventLogHistory, bool>> _predicate = modelQuery.GetNativeReduction() as Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.History_EventLogHistory, bool>>;

				if ((object)_predicate == null)
					throw new InvalidOperationException(string.Format("Model query object of type '{0}' returned an invalid native reduction (inner query); expected type is '{1}'.", modelQuery.GetType().FullName, typeof(Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.History_EventLogHistory, bool>>).FullName));
			...
			{
				Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.History_EmailMessageHistory, bool>> _predicate = modelQuery.GetNativeReduction() as Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.History_EmailMessageHistory, bool>>;

				if ((object)_predicate == null)
					throw new InvalidOperationException(string.Format("Model query object of type '{0}' returned an invalid native reduction (inner query); expected type is '{1}'.", modelQuery.GetType().FullName, typeof(Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.History_EmailMessageHistory, bool>>).FullName));
			...
			{
				Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.History_EmailAttachmentHistory, bool>> _predicate = modelQuery.GetNativeReduction() as Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.History_EmailAttachmentHistory, bool>>;

				if ((object)_predicate == null)
					throw new InvalidOperationException(string.Format("Model query object of type '{0}' returned an invalid native reduction (inner query); expected type is '{1}'.", modelQuery.GetType().FullName, typeof(Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.History_EmailAttachmentHistory, bool>>).FullName));
			...
			{
				Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Testcases_Tab_with_primary_key_as_identity, bool>> _predicate = modelQuery.GetNativeReduction() as Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Testcases_Tab_with_primary_key_as_identity, bool>>;

				if ((object)_predicate == null)
					throw new InvalidOperationException(string.Format("Model query object of type '{0}' returned an invalid native reduction (inner query); expected type is '{1}'.", modelQuery.GetType().FullName, typeof(Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Testcases_Tab_with_primary_key_as_identity, bool>>).FullName));
			...
			{
				Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Testcases_Tab_with_primary_key_as_default, bool>> _predicate = modelQuery.GetNativeReduction() as Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Testcases_Tab_with_primary_key_as_default, bool>>;

				if ((object)_predicate == null)
					throw new InvalidOperationException(string.Format("Model query object of type '{0}' returned an invalid native reduction (inner query); expected type is '{1}'.", modelQuery.GetType().FullName, typeof(Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Testcases_Tab_with_primary_key_as_default, bool>>).FullName));
			...
			{
				Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Testcases_Tab_with_primary_key_with_different_identity, bool>> _predicate = modelQuery.GetNativeReduction() as Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Testcases_Tab_with_primary_key_with_different_identity, bool>>;

				if ((object)_predicate == null)
					throw new InvalidOperationException(string.Format("Model query object of type '{0}' returned an invalid native reduction (inner query); expected type is '{1}'.", modelQuery.GetType().FullName, typeof(Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Testcases_Tab_with_primary_key_with_different_identity, bool>>).FullName));
			...
			{
				Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Testcases_Tab_with_no_primary_key_with_identity, bool>> _predicate = modelQuery.GetNativeReduction() as Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Testcases_Tab_with_no_primary_key_with_identity, bool>>;

				if ((object)_predicate == null)
					throw new InvalidOperationException(string.Format("Model query object of type '{0}' returned an invalid native reduction (inner query); expected type is '{1}'.", modelQuery.GetType().FullName, typeof(Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Testcases_Tab_with_no_primary_key_with_identity, bool>>).FullName));
			...
			{
				Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Testcases_Tab_with_primary_key_no_identity, bool>> _predicate = modelQuery.GetNativeReduction() as Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Testcases_Tab_with_primary_key_no_identity, bool>>;

				if ((object)_predicate == null)
					throw new InvalidOperationException(string.Format("Model query object of type '{0}' returned an invalid native reduction (inner query); expected type is '{1}'.", modelQuery.GetType().FullName, typeof(Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Testcases_Tab_with_primary_key_no_identity, bool>>).FullName));
			...
			{
				Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Testcases_Tab_no_primary_key_no_identity, bool>> _predicate = modelQuery.GetNativeReduction() as Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Testcases_Tab_no_primary_key_no_identity, bool>>;

				if ((object)_predicate == null)
					throw new InvalidOperationException(string.Format("Model query object of type '{0}' returned an invalid native reduction (inner query); expected type is '{1}'.", modelQuery.GetType().FullName, typeof(Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Testcases_Tab_no_primary_key_no_identity, bool>>).FullName));

				return (IEnumerable<TModel>)this.LinqFind<ITabNoPrimaryKeyNoIdentity, TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Testcases_Tab_no_primary_key_no_identity>(unitOfWork, _predicate, (dm, st) => { dm.@ColBigint = st.@Col_bigint; dm.@ColBinary = (object)st.@Col_binary != null ? st.@Col_binary.ToArray() : null; dm.@ColBit = st.@Col_bit; dm.@ColChar = st.@Col_char; dm.@ColDate = st.@Col_date; dm.@ColDatetime = st.@Col_datetime; dm.@ColDatetime2 = st.@Col_datetime2; dm.@ColDatetimeoffset = st.@Col_datetimeoffset; dm.@ColDecimal = st.@Col_decimal; dm.@ColFloat = st.@Col_float; dm.@ColImage = (object)st.@Col_image != null ? st.@Col_image.ToArray() : null; dm.@ColInt = st.@Col_int; dm.@ColMoney = st.@Col_money; dm.@ColNchar = st.@Col_nchar; dm.@ColNtext = st.@Col_ntext; dm.@ColNumeric = st.@Col_numeric; dm.@ColNvarchar = st.@Col_nvarchar; dm.@ColReal = st.@Col_real; dm.@ColRowversion = (object)st.@Col_rowversion != null ? st.@Col_rowversion.ToArray() : null; dm.@ColSmalldatetime = st.@Col_smalldatetime; dm.@ColSmallint = st.@Col_smallint; dm.@ColSmallmoney = st.@Col_smallmoney; dm.@ColSqlVariant = st.@Col_sql_variant; dm.@ColSysname = st.@Col_sysname; dm.@ColText = st.@Col_text; dm.@ColTime = st.@Col_time; dm.@ColTinyint = st.@Col_tinyint; dm.@ColUniqueidentifier = st.@Col_uniqueidentifier; dm.@ColVarbinary = (object)st.@Col_varbinary != null ? st.@Col_varbinary.ToArray() : null; dm.@ColVarchar = st.@Col_varchar; dm.@ColXml = (object)st.@Col_xml != null ? ToXmlDocument(st.@Col_xml) : null; });
			}
			else if (modelType == typeof(ITabWithCompositePrimaryKeyNoIdentity))
			{
				Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Testcases_Tab_with_composite_primary_key_no_identity, bool>> _predicate = modelQuery.GetNativeReduction() as Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Testcases_Tab_with_composite_primary_key_no_identity, bool>>;

				if ((object)_predicate == null)
					throw new InvalidOperationException(string.Format("Model query object of type '{0}' returned an invalid native reduction (inner query); expected type is '{1}'.", modelQuery.GetType().FullName, typeof(Expression<Func<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Testcases_Tab_with_composite_primary_key_no_identity, bool>>).FullName));
