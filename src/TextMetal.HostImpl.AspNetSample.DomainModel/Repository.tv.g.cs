...
namespace TextMetal.HostImpl.AspNetSample.DomainModel
{
	...
	{		
		...
		public Organization LoadOrganization(Int32 @organizationId)
		{
		...
		public Organization LoadOrganization(IUnitOfWork unitOfWork, Int32 @organizationId)
		{			
			Organization @organization;
		...
		public IEnumerable<Organization> FindOrganizations(Func<IQueryable<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Organization>, IQueryable<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Organization>> callback)
		{
		...
		public IEnumerable<Organization> FindOrganizations(IUnitOfWork unitOfWork, Func<IQueryable<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Organization>, IQueryable<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Organization>> callback)
		{
			IEnumerable<Organization> @organizations;			
			...
			using (AmbientUnitOfWorkAwareDisposableWrapper<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.TextMetalOdsDataContext> wrapper = unitOfWork.GetContext<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.TextMetalOdsDataContext>())
			{
				...
				@organizations = queryable.Select(lo => new Organization()
												 {
		...
		public bool SaveOrganization(IUnitOfWork unitOfWork, Organization @organization)
		{
			TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Organization query;
			bool wasNew;
		...
		public bool DiscardOrganization(Organization @organization)
		{
			bool retval;
		...
		public bool DiscardOrganization(IUnitOfWork unitOfWork, Organization @organization)
		{
			TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Organization query;
		...
		public Member LoadMember(Int32 @memberId)
		{
			Member @member;
		...
		public Member LoadMember(IUnitOfWork unitOfWork, Int32 @memberId)
		{			
			Member @member;
		...
		public IEnumerable<Member> FindMembers(Func<IQueryable<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Member>, IQueryable<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Member>> callback)
		{
		...
		public IEnumerable<Member> FindMembers(IUnitOfWork unitOfWork, Func<IQueryable<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Member>, IQueryable<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Member>> callback)
		{
			IEnumerable<Member> @members;			
			...
			using (AmbientUnitOfWorkAwareDisposableWrapper<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.TextMetalOdsDataContext> wrapper = unitOfWork.GetContext<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.TextMetalOdsDataContext>())
			{
				...
				@members = queryable.Select(lo => new Member()
												 {
													// map results to POCOs from L2S objects
		...
		public bool SaveMember(IUnitOfWork unitOfWork, Member @member)
		{
			TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Member query;
			bool wasNew;
		...
		public bool DiscardMember(Member @member)
		{
			bool retval;
		...
		public bool DiscardMember(IUnitOfWork unitOfWork, Member @member)
		{
			TextMetal.HostImpl.AspNetSample.DomainModel.L2S.Member query;
		...
		public SecurityRole LoadSecurityRole(Int32 @securityRoleId)
		{
		...
		public SecurityRole LoadSecurityRole(IUnitOfWork unitOfWork, Int32 @securityRoleId)
		{			
			SecurityRole @securityRole;
		...
		public IEnumerable<SecurityRole> FindSecurityRoles(Func<IQueryable<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.SecurityRole>, IQueryable<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.SecurityRole>> callback)
		{
		...
		public IEnumerable<SecurityRole> FindSecurityRoles(IUnitOfWork unitOfWork, Func<IQueryable<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.SecurityRole>, IQueryable<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.SecurityRole>> callback)
		{
			IEnumerable<SecurityRole> @securityRoles;			
			...
			using (AmbientUnitOfWorkAwareDisposableWrapper<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.TextMetalOdsDataContext> wrapper = unitOfWork.GetContext<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.TextMetalOdsDataContext>())
			{
				...
				@securityRoles = queryable.Select(lo => new SecurityRole()
												 {
													// map results to POCOs from L2S objects
													@SecurityRoleId = lo.@SecurityRoleId,
		...
		public bool SaveSecurityRole(SecurityRole @securityRole)
		{
			bool retval;
		...
		public bool SaveSecurityRole(IUnitOfWork unitOfWork, SecurityRole @securityRole)
		{
			TextMetal.HostImpl.AspNetSample.DomainModel.L2S.SecurityRole query;
			bool wasNew;
		...
		public bool DiscardSecurityRole(SecurityRole @securityRole)
		{
			bool retval;
		...
		public bool DiscardSecurityRole(IUnitOfWork unitOfWork, SecurityRole @securityRole)
		{
			TextMetal.HostImpl.AspNetSample.DomainModel.L2S.SecurityRole query;
		...
		public OrganizationHistory LoadOrganizationHistory(Int64 @organizationHistoryId)
		{
		...
		public OrganizationHistory LoadOrganizationHistory(IUnitOfWork unitOfWork, Int64 @organizationHistoryId)
		{			
			OrganizationHistory @organizationHistory;
		...
		public IEnumerable<OrganizationHistory> FindOrganizationHistories(Func<IQueryable<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.OrganizationHistory>, IQueryable<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.OrganizationHistory>> callback)
		{
			IEnumerable<OrganizationHistory> @organizationHistories;
		...
		public IEnumerable<OrganizationHistory> FindOrganizationHistories(IUnitOfWork unitOfWork, Func<IQueryable<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.OrganizationHistory>, IQueryable<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.OrganizationHistory>> callback)
		{
			IEnumerable<OrganizationHistory> @organizationHistories;			
			...
			using (AmbientUnitOfWorkAwareDisposableWrapper<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.TextMetalOdsDataContext> wrapper = unitOfWork.GetContext<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.TextMetalOdsDataContext>())
			{
				...
				@organizationHistories = queryable.Select(lo => new OrganizationHistory()
												 {
													// map results to POCOs from L2S objects
				...
				foreach (OrganizationHistory @organizationHistory in @organizationHistories)
				{
					this.OnSelectOrganizationHistory(unitOfWork, @organizationHistory);
		...
		public bool SaveOrganizationHistory(OrganizationHistory @organizationHistory)
		{
			bool retval;
		...
		public bool SaveOrganizationHistory(IUnitOfWork unitOfWork, OrganizationHistory @organizationHistory)
		{
			TextMetal.HostImpl.AspNetSample.DomainModel.L2S.OrganizationHistory query;
			bool wasNew;
		...
		public bool DiscardOrganizationHistory(OrganizationHistory @organizationHistory)
		{
			bool retval;
		...
		public bool DiscardOrganizationHistory(IUnitOfWork unitOfWork, OrganizationHistory @organizationHistory)
		{
			TextMetal.HostImpl.AspNetSample.DomainModel.L2S.OrganizationHistory query;
		...
		public MemberHistory LoadMemberHistory(Int64 @memberHistoryId)
		{
		...
		public MemberHistory LoadMemberHistory(IUnitOfWork unitOfWork, Int64 @memberHistoryId)
		{			
			MemberHistory @memberHistory;
		...
		public IEnumerable<MemberHistory> FindMemberHistories(Func<IQueryable<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.MemberHistory>, IQueryable<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.MemberHistory>> callback)
		{
			IEnumerable<MemberHistory> @memberHistories;
		...
		public IEnumerable<MemberHistory> FindMemberHistories(IUnitOfWork unitOfWork, Func<IQueryable<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.MemberHistory>, IQueryable<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.MemberHistory>> callback)
		{
			IEnumerable<MemberHistory> @memberHistories;			
			...
			using (AmbientUnitOfWorkAwareDisposableWrapper<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.TextMetalOdsDataContext> wrapper = unitOfWork.GetContext<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.TextMetalOdsDataContext>())
			{
				...
				@memberHistories = queryable.Select(lo => new MemberHistory()
												 {
													// map results to POCOs from L2S objects
				...
				foreach (MemberHistory @memberHistory in @memberHistories)
				{
					this.OnSelectMemberHistory(unitOfWork, @memberHistory);
		...
		public bool SaveMemberHistory(MemberHistory @memberHistory)
		{
			bool retval;
		...
		public bool SaveMemberHistory(IUnitOfWork unitOfWork, MemberHistory @memberHistory)
		{
			TextMetal.HostImpl.AspNetSample.DomainModel.L2S.MemberHistory query;
			bool wasNew;
		...
		public bool DiscardMemberHistory(MemberHistory @memberHistory)
		{
			bool retval;
		...
		public bool DiscardMemberHistory(IUnitOfWork unitOfWork, MemberHistory @memberHistory)
		{
			TextMetal.HostImpl.AspNetSample.DomainModel.L2S.MemberHistory query;
		...
		public SecurityRoleHistory LoadSecurityRoleHistory(Int64 @securityRoleHistoryId)
		{
			SecurityRoleHistory @securityRoleHistory;
		...
		public SecurityRoleHistory LoadSecurityRoleHistory(IUnitOfWork unitOfWork, Int64 @securityRoleHistoryId)
		{			
			SecurityRoleHistory @securityRoleHistory;
			...
			{					
				...
				@securityRoleHistory = new SecurityRoleHistory()
								{
									// map result to POCO from L2S object
		...
		public IEnumerable<SecurityRoleHistory> FindSecurityRoleHistories(Func<IQueryable<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.SecurityRoleHistory>, IQueryable<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.SecurityRoleHistory>> callback)
		{
			IEnumerable<SecurityRoleHistory> @securityRoleHistories;
		...
		public IEnumerable<SecurityRoleHistory> FindSecurityRoleHistories(IUnitOfWork unitOfWork, Func<IQueryable<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.SecurityRoleHistory>, IQueryable<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.SecurityRoleHistory>> callback)
		{
			IEnumerable<SecurityRoleHistory> @securityRoleHistories;			
			...
			using (AmbientUnitOfWorkAwareDisposableWrapper<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.TextMetalOdsDataContext> wrapper = unitOfWork.GetContext<TextMetal.HostImpl.AspNetSample.DomainModel.L2S.TextMetalOdsDataContext>())
			{
				...
				@securityRoleHistories = queryable.Select(lo => new SecurityRoleHistory()
												 {
													// map results to POCOs from L2S objects
				...
				foreach (SecurityRoleHistory @securityRoleHistory in @securityRoleHistories)
				{
					this.OnSelectSecurityRoleHistory(unitOfWork, @securityRoleHistory);
		...
		public bool SaveSecurityRoleHistory(SecurityRoleHistory @securityRoleHistory)
		{
			bool retval;
		...
		public bool SaveSecurityRoleHistory(IUnitOfWork unitOfWork, SecurityRoleHistory @securityRoleHistory)
		{
			TextMetal.HostImpl.AspNetSample.DomainModel.L2S.SecurityRoleHistory query;
			bool wasNew;
		...
		public bool DiscardSecurityRoleHistory(SecurityRoleHistory @securityRoleHistory)
		{
			bool retval;
		...
		public bool DiscardSecurityRoleHistory(IUnitOfWork unitOfWork, SecurityRoleHistory @securityRoleHistory)
		{
			TextMetal.HostImpl.AspNetSample.DomainModel.L2S.SecurityRoleHistory query;
