...
using IEmailMessage = TextMetal.HostImpl.AspNetSample.DomainModel.Tables.IEmailMessage;
using IEmailAttachment = TextMetal.HostImpl.AspNetSample.DomainModel.Tables.IEmailAttachment;
