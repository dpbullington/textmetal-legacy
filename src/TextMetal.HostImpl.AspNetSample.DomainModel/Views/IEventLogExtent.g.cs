...
{
	public partial interface IEventLogExtent : IModelObject
	{		
		#region Properties/Indexers/Events

		/* PRIMARY_KEY */
		Nullable<DateTime> @MinCreationTimestamp
		{
			get;
			set;
		}
		...
		/* PRIMARY_KEY */
		Nullable<Int32> @AvgDifferenceTimestamps
		{
			get;
			set;
		}
		...
		/* PRIMARY_KEY */
		Nullable<DateTime> @MaxModificationTimestamp
		{
			get;
			set;
		}
