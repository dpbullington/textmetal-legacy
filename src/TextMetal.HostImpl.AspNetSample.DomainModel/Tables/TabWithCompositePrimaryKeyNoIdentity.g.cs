...
{
	public partial class TabWithCompositePrimaryKeyNoIdentity : Object, INotifyPropertyChanged, ITabWithCompositePrimaryKeyNoIdentity
	{
		#region Constructors/Destructors

		public TabWithCompositePrimaryKeyNoIdentity()
		{
		}
		...
		public const string TABLE_NAME = "tab_with_composite_primary_key_no_identity";
		public const bool HAS_SINGLE_COLUMN_SERVER_GENERATED_PRIMARY_KEY = false;
		public const string COLUMN_NAME_COLINTPK0 = "col_int_pk0";
		public const string COLUMN_NAME_COLINTPK1 = "col_int_pk1";
		public const string COLUMN_NAME_COLINTPK2 = "col_int_pk2";
		public const string COLUMN_NAME_COLINTPK3 = "col_int_pk3";
		...
		private Nullable<Int32> @colIntPk0;
		private Nullable<Int32> @colIntPk1;
		private Nullable<Int32> @colIntPk2;
		private Nullable<Int32> @colIntPk3;
		...
		/* PRIMARY_KEY */
		public Nullable<Int32> @ColIntPk0
		{
			get
			{
				return this.@colIntPk0;
			}
			set
			{
				if (!DataType.ObjectsEqualValueSemantics(this.@colIntPk0, value))
				{
					this.@colIntPk0 = value;
					OnPropertyChanged("ColIntPk0");
				}
			}
		}
		
		/* PRIMARY_KEY */
		public Nullable<Int32> @ColIntPk1
		{
			get
			{
				return this.@colIntPk1;
			}
			set
			{
				if (!DataType.ObjectsEqualValueSemantics(this.@colIntPk1, value))
				{
					this.@colIntPk1 = value;
					OnPropertyChanged("ColIntPk1");
				}
			}
		}
		
		/* PRIMARY_KEY */
		public Nullable<Int32> @ColIntPk2
		{
			get
			{
				return this.@colIntPk2;
			}
			set
			{
				if (!DataType.ObjectsEqualValueSemantics(this.@colIntPk2, value))
				{
					this.@colIntPk2 = value;
					OnPropertyChanged("ColIntPk2");
				}
			}
		}
		
		/* PRIMARY_KEY */
		public Nullable<Int32> @ColIntPk3
		{
			get
			{
				return this.@colIntPk3;
			}
			set
			{
				if (!DataType.ObjectsEqualValueSemantics(this.@colIntPk3, value))
				{
					this.@colIntPk3 = value;
					OnPropertyChanged("ColIntPk3");
				}
			}
		}
