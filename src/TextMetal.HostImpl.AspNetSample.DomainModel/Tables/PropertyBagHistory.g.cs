...
{
	public partial class PropertyBagHistory : Object, INotifyPropertyChanged, IPropertyBagHistory
	{
		...
		public const string TABLE_NAME = "PropertyBagHistory";
		public const bool HAS_SINGLE_COLUMN_SERVER_GENERATED_PRIMARY_KEY = true;
		public const string COLUMN_NAME_PROPERTY_BAG_HISTORY_ID = "PropertyBagHistoryId";
		public const string COLUMN_NAME_PROPERTY_BAG_HISTORY_TS = "PropertyBagHistoryTs";
		...
		public Nullable<Int64> @PropertyBagHistoryId
		{
			...
			set
			{
				if (!DataType.ObjectsEqualValueSemantics(this.@propertyBagHistoryId, value))
				{
					this.@propertyBagHistoryId = value;
					OnPropertyChanged("PropertyBagHistoryId");
				}
			}
		}
		...
		public Nullable<DateTime> @PropertyBagHistoryTs
		{
			...
			set
			{
				if (!DataType.ObjectsEqualValueSemantics(this.@propertyBagHistoryTs, value))
				{
					this.@propertyBagHistoryTs = value;
					OnPropertyChanged("PropertyBagHistoryTs");
				}
			}
		}
