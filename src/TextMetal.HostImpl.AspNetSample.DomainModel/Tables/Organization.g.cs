...
{
	public partial class Organization : Object, INotifyPropertyChanged, IOrganization
	{
		...
		public const string TABLE_NAME = "Organization";
		...
		public virtual bool IsNew
		{
			get
			{
				return this.@OrganizationId == default(Nullable<Int32>);
			}
			set
			{
				if(value)
					this.@OrganizationId =  default(Nullable<Int32>);
			}
		}
