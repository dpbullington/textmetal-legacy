...
{
	public partial class TabWithPrimaryKeyAsDefault : Object, INotifyPropertyChanged, ITabWithPrimaryKeyAsDefault
	{
		...
		public Nullable<Guid> @ColUuidDfPk
		{
			...
			set
			{
				if (!DataType.ObjectsEqualValueSemantics(this.@colUuidDfPk, value))
				{
					this.@colUuidDfPk = value;
					OnPropertyChanged("ColUuidDfPk");
				}
			}
		}
