...
{
	public partial class SecurityRoleHistory : Object, INotifyPropertyChanged, ISecurityRoleHistory
	{
		...
		public const string TABLE_NAME = "SecurityRoleHistory";
		public const bool HAS_SINGLE_COLUMN_SERVER_GENERATED_PRIMARY_KEY = true;
		public const string COLUMN_NAME_SECURITY_ROLE_HISTORY_ID = "SecurityRoleHistoryId";
		public const string COLUMN_NAME_SECURITY_ROLE_HISTORY_TS = "SecurityRoleHistoryTs";
		...
		public Nullable<Int64> @SecurityRoleHistoryId
		{
			...
			set
			{
				if (!DataType.ObjectsEqualValueSemantics(this.@securityRoleHistoryId, value))
				{
					this.@securityRoleHistoryId = value;
					OnPropertyChanged("SecurityRoleHistoryId");
				}
			}
		}
		...
		public Nullable<DateTime> @SecurityRoleHistoryTs
		{
			...
			set
			{
				if (!DataType.ObjectsEqualValueSemantics(this.@securityRoleHistoryTs, value))
				{
					this.@securityRoleHistoryTs = value;
					OnPropertyChanged("SecurityRoleHistoryTs");
				}
			}
		}
