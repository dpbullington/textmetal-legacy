...
{
	public partial class TabWithPrimaryKeyAsIdentity : Object, INotifyPropertyChanged, ITabWithPrimaryKeyAsIdentity
	{
		...
		public Nullable<Int32> @ColIntIdPk
		{
			...
			set
			{
				if (!DataType.ObjectsEqualValueSemantics(this.@colIntIdPk, value))
				{
					this.@colIntIdPk = value;
					OnPropertyChanged("ColIntIdPk");
				}
			}
		}
