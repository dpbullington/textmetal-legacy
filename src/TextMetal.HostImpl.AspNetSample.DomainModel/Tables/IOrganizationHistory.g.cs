...
{
	public partial interface IOrganizationHistory : IModelObject
	{		
		#region Properties/Indexers/Events

		/* PRIMARY_KEY */
		Nullable<Int64> @OrganizationHistoryId
		{
			get;
			set;
		}
		
		Nullable<DateTime> @OrganizationHistoryTs
		{
			get;
			set;
		}
		...
		Nullable<Int32> @ParentOrganizationId
		{
			get;
			set;
		}
