...
{
	public partial class TabWithNoPrimaryKeyWithIdentity
	{		
		#region Methods/Operators
		
		public static bool Exists(TabWithNoPrimaryKeyWithIdentity tabWithNoPrimaryKeyWithIdentity)
		{
			...
			tabWithNoPrimaryKeyWithIdentities =
				Stuff.Get<IRepository>("").FindTabWithNoPrimaryKeyWithIdentities(
					q =>
						q.Where(
							z =>
								(z.XXX == tabWithNoPrimaryKeyWithIdentity.XXX) && ((object)tabWithNoPrimaryKeyWithIdentity.TabWithNoPrimaryKeyWithIdentityId == null || z.TabWithNoPrimaryKeyWithIdentityId != tabWithNoPrimaryKeyWithIdentity.TabWithNoPrimaryKeyWithIdentityId)));

			return tabWithNoPrimaryKeyWithIdentities.Count() > 0;
		}
		...
		public virtual Message[] Validate()
		{
			...
			if (exists)
				messages.Add(new Message("", "TabWithNoPrimaryKeyWithIdentity must be unique.", Severity.Error));
