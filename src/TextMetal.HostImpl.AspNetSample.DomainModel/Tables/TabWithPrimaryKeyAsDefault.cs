...
{
	public partial class TabWithPrimaryKeyAsDefault
	{		
		#region Methods/Operators
		
		public static bool Exists(TabWithPrimaryKeyAsDefault tabWithPrimaryKeyAsDefault)
		{
			...
			tabWithPrimaryKeyAsDefaults =
				Stuff.Get<IRepository>("").FindTabWithPrimaryKeyAsDefaults(
					q =>
						q.Where(
							z =>
								(z.XXX == tabWithPrimaryKeyAsDefault.XXX) && ((object)tabWithPrimaryKeyAsDefault.TabWithPrimaryKeyAsDefaultId == null || z.TabWithPrimaryKeyAsDefaultId != tabWithPrimaryKeyAsDefault.TabWithPrimaryKeyAsDefaultId)));

			return tabWithPrimaryKeyAsDefaults.Count() > 0;
		}
		...
		public virtual Message[] Validate()
		{
			...
			if (exists)
				messages.Add(new Message("", "TabWithPrimaryKeyAsDefault must be unique.", Severity.Error));
